...
then
    ...
    cp $TEGRA_ROOT/../customers/nvidia/bonaire/nvflash/bonaire_13Mhz_H5TQ1G83BFR-H9C_13Mhz_1GB_emmc_H26M42001EFR_x8.bct $TOP/$OUTDIR/flash.bct
    cp $TEGRA_ROOT/../customers/nvidia/bonaire/nvflash/android_fastboot_emmc_full.cfg                                   $TOP/$OUTDIR/flash.cfg
    export NVFLASH_ODM_DATA=0x40080105
else
    echo "Setting up NvFlash BCT for Bonaire with LPDDR2 SDRAM......"
    cp $TEGRA_ROOT/../customers/nvidia/bonaire/nvflash/bonaire_13Mhz_H8TBR00Q0MLR_13Mhz_256MB_emmc_H26M42001EFR_x8.bct  $TOP/$OUTDIR/flash.bct
    cp $TEGRA_ROOT/../customers/nvidia/bonaire/nvflash/android_fastboot_emmc_full.cfg                                   $TOP/$OUTDIR/flash.cfg
