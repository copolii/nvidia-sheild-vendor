...
then
    ...
    cp $TEGRA_TOP/customers/nvidia/aruba2/nvflash/android_fastboot_emmc_full.cfg                                  $TOP/$OUTDIR/flash.cfg
    _NVFLASH_ODM_DATA=0x40080105
else
